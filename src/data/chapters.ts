...
export const CHAPTER_CONTENT: readonly ChapterContent[] = [
  ...
  },
  {
    ...
    summary:
      "Outsourced by Planet01 to Vaulsys, with about fifteen days to learn enough Java to join, then assigned to systems for Rawbank, the largest commercial bank in the Democratic Republic of Congo. Java, Spring Boot and Vaadin, against Oracle, on systems where a bad deploy is somebody's salary.",
    outcome:
      "Change requests, production fixes and routine production deploys on Rawbank's banking systems, through Vaulsys.",
    stack: ["Java", "Spring Boot", "Vaadin", "Hibernate", "Oracle SQL"],
    href: "/projects#vaulsys",
    sections: [
      {
  ...
  },
  {
    ...
    start: "2025",
    role: "BBIT, Bachelor of Business and Information Technology",
    resumeSection: "education",
    org: "Virtual University of Pakistan",
    startYear: 2025,
    status: "ongoing",
    headline: "Still studying",
    roleLine: "BBIT at Virtual University of Pakistan, alongside full time work.",
    summary:
      "Bachelor of Business and Information Technology (BBIT) at Virtual University of Pakistan, taken alongside a full time engineering job. The business half of it is more useful than I expected for ERP work, where the hard part is usually the accounting rather than the code.",
