 ...
 *
 * Terrain mottling, cobble shapes and bush silhouettes are generated, so they
 * must be stable: the same seed produces the same coastline on every reload.
 * Prop *placement* is not random at all — see GroundLayout.
 */
